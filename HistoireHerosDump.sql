...
--
-- Host: localhost    Database: HistoireHeros
-- ------------------------------------------------------
...
(1310111,'Vous sortez du magasin'),
...
CREATE TABLE `Inventaire` (
  ...
  PRIMARY KEY (`Id_perso`,`id_objet`),
  KEY `id_objet` (`id_objet`),
  CONSTRAINT `Inventaire_ibfk_1` FOREIGN KEY (`Id_perso`) REFERENCES `Personnage` (`id_perso`),
  CONSTRAINT `Inventaire_ibfk_2` FOREIGN KEY (`id_objet`) REFERENCES `Objets` (`id_objet`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'soin','Potion de soin',30),
(2,'soin','Grande potion',60),
(3,'attaque','Bombe de feu',25),
(4,'attaque','Parchemin de foudre',40);
